...
var _PSMove_instances, _PSMove_device, _PSMove_lastData, _PSMove_interval, _PSMove_handle, _PSMove_color, _PSMove_rumble, _PSMove_lastColor, _PSMove_lastRumble, _PSMove_update;
...
class PSMove extends events_1.default {
    constructor(ready) {
        ...
        _PSMove_interval.set(this, void 0);
        ...
        (() => __awaiter(this, void 0, void 0, function* () {
            ...
            __classPrivateFieldSet(this, _PSMove_interval, setInterval(() => {
                if (__classPrivateFieldGet(this, _PSMove_lastColor, "f").hex('rgb') !== '#000000' && __classPrivateFieldGet(this, _PSMove_rumble, "f") !== 0)
                    __classPrivateFieldGet(this, _PSMove_instances, "m", _PSMove_update).call(this);
            }, 4e3), "f");
            if (ready)
                ready();
        }))();
    ...
    update() {
        return __awaiter(this, void 0, void 0, function* () {
            if (__classPrivateFieldGet(this, _PSMove_lastColor, "f").hex('rgb') === __classPrivateFieldGet(this, _PSMove_color, "f").hex('rgb') &&
                ...
                return true;
            return yield __classPrivateFieldGet(this, _PSMove_instances, "m", _PSMove_update).call(this);
        });
    }
    destroy() {
        return __awaiter(this, void 0, void 0, function* () {
            if (__classPrivateFieldGet(this, _PSMove_interval, "f"))
                clearInterval(__classPrivateFieldGet(this, _PSMove_interval, "f"));
            if (__classPrivateFieldGet(this, _PSMove_device, "f"))
                yield __classPrivateFieldGet(this, _PSMove_device, "f").close();
        });
    }
}
exports.PSMove = PSMove;
_PSMove_device = new WeakMap(), _PSMove_lastData = new WeakMap(), _PSMove_interval = new WeakMap(), _PSMove_color = new WeakMap(), _PSMove_rumble = new WeakMap(), _PSMove_lastColor = new WeakMap(), _PSMove_lastRumble = new WeakMap(), _PSMove_instances = new WeakSet(), _PSMove_handle = function _PSMove_handle(buffer) {
...
}, _PSMove_update = function _PSMove_update() {
    return __awaiter(this, void 0, void 0, function* () {
        if (!__classPrivateFieldGet(this, _PSMove_device, "f"))
            return false;
